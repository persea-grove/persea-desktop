 ...
 *
 * ES module since the vite migration (T6): invoke comes from
 * @tauri-apps/api/core, listen from @tauri-apps/api/event. The IIFE
 * wrapper went away with it: module scope is already isolated.
 */
...
/* Outside Tauri (plain browser) the import chain rejects and this
 * whole page degrades to a static empty strip. */
